...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
	   	//db.execSQL("Create table posts(id int PRIMARY KEY autoincrement,post text not null, date date)");
	   	//db.execSQL("Create table friends(id int PRIMARY KEY autoincrement,username text not null, date date,friendname text)");
	   	//username is owners username, friendname is friends username;
